...
Service.prototype.checkVariant = function (metadata, options) {
...
Service.prototype.getImageFromS3 = function (metadata, callback) {
  var that = this
...
Service.prototype.getVariant = function (metadata, options, callback) {
  metadata = metadata || {}
  options = options || {}
