...
Simgr.prototype.getVariant = function (metadata, options, callback) {
  ...
  this.getImageFromS3(metadata, function (err, filename) {
    if (err)
      return callback(err)

    this.resizeImage(filename, metadata, options, callback)
  })
...
// Private
// callback(function (err, filename))
Simgr.prototype.resizeImage = function (filename, metadata, options) {
...
// Private
Simgr.prototype.resizeImagemagick = function (filename, metadata, options, callback) {
  var that = this
